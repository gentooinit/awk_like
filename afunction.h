...
extern afield::mapped_type operator+(const map::Proxy &lhs, const map::Proxy &rhs);
extern afield::mapped_type operator+(const map::Proxy &lhs, const afield::mapped_type &rhs);
extern afield::mapped_type operator+(const afield::mapped_type &lhs, const map::Proxy &rhs);
